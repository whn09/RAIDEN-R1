#!/usr/bin/env python3
"""
Quick test script for Bedrock data generator
...
def test_single_sample():
    ...
    print("=" * 70)
    print("Testing Bedrock Data Generator - Single Sample")
    print("=" * 70)

    # Initialize generator
    print("\n1. Initializing Bedrock generator...")
    try:
        ...
        print("  - You have access to Bedrock in us-east-1")
        print("  - Claude 3.5 Sonnet model is enabled")
        return 1
    ...
    print("  python scripts/generate_data_with_bedrock.py")
